...
public class ExamenBean {
	...
	public ExamenBean(int idexamen, Date fecha_examen, Time hora_inicio, Time hora_fin, int iduniversidad, int idciclo,
	...
	public String toString() {
		return "ExamenBean [idexamen=" + idexamen + ", fecha_examen=" + fecha_examen + ", hora_inicio=" + hora_inicio
				+ ", hora_fin=" + hora_fin + ", iduniversidad=" + iduniversidad + ", idciclo=" + idciclo + ", idarea="
				+ idarea + ", puede_retroceder=" + puede_retroceder + ", encuesta=" + encuesta + ", fecha_inicio="
				+ fecha_inicio + ", fecha_fin=" + fecha_fin + ", idusuario=" + idusuario + ", estado=" + estado
				+ ", salto_pregunta=" + salto_pregunta + ", tipo_examen=" + tipo_examen + ", lista_temas=" + lista_temas
				+ ", ciclos=" + ciclos + "]";
	}
